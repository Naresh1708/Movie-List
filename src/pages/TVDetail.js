...
const TVDetail = () => {
    ...
    useEffect(() => {
      async function fetchmovie(){
        const response = await fetch(`https://api.themoviedb.org/3/tv/${params.id}?api_key=f24a940997520342a0f2fa5c2bb9d2cb`);
    ...
    <main>
      <section className="flex justify-around flex-wrap py-5">
        ...
        <div className="max-w-2xl text-gray-700 text-lg dark:text-white">
          <h1 className="text-4xl font-bold my-3 text-center lg:text-left">{movie.original_name}</h1>
          ...
          <p className="my-4">
            <span className="mr-2 font-bold">No of Seasons:</span>
            <span>{movie.number_of_seasons}</span>
          </p>

          <p className="my-4">
            <span className="mr-2 font-bold">No of Episodes:</span>
